...
\thanks{Footnote to First Author with the `thanks' command.}
...
Carr-Goldstein based their model on balancing\linebreak methods and
...
Carr-Goldstein
based their model on balancing\linebreak methods and
biochemical know\-ledge. The original model (1980) contained an equation for the
oxygen dynamics which has been omitted in a second paper
(1981). This simplified model shall be discussed here.
